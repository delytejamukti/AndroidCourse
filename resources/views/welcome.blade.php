		...
		<div id="home" class="hero-area">
			...
			<div class="home-wrapper">
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							<h1 class="white-text">Edusite Free Online Android Course</h1>
							<p class="lead white-text">Start Your Android Programming Skill here</p>
							<a class="main-button icon-button" href="{{ route('login') }}">Get Started!</a>
						</div>
					</div>
				</div>
			</div>
		...
		<div id="about" class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="about-img">
							<img src="{{asset('img/blog-post-background.jpg')}}" alt=""> 
						</div>
					</div>
